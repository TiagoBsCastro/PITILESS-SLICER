...
if not rank:
   ...
   print("Building the concentration interpolator")
   ...
   c_interp = RectBivariateSpline( z_interp, m_interp, c_interp )
   ...
   for z1, z2 in zip(cosmology.zlinf, cosmology.zlsup):
      ...
      if params.numfiles > 1:
         ...
         for snapnum in range(params.numfiles):
            ...
            conc   = c_interp(plc.redshift[groupsinplane], plc.Mass[groupsinplane], grid=False).astype(np.float32)
